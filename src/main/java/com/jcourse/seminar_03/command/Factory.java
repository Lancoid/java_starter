...
import com.jcourse.seminar_03.annotation.Injection;
import com.jcourse.seminar_03.parser.Parser;
...
public class Factory
{
    ...
    public Factory(Parser parser, Stack<Double> stack, Map<String, Double> variablesMap)
    {
        ...
        try {
            ...
            InputStream stream = Factory.class.getClassLoader().getResourceAsStream("seminar03.commands.properties");
